...
class PDPoSDutyPBFTVote extends PSMDPoSNet[PDutyTermResult] {
  override def service = PDPoSDutyPBFTVote
}

//
// http://localhost:8000/fbs/xdn/pbget.do?bd=
object PDPoSDutyPBFTVote extends LogHelper with PBUtils with LService[PDutyTermResult] with PMNodeHelper {
